...
<head>
    ...
    <title>Admin Verification — MandiSecure</title>
    ...
    <style>
        ...
        .digit-box:focus { border-color: var(--ms-green); box-shadow: 0 0 0 3px rgba(26,107,60,0.15); }
...
<div class="otp-card">
    ...
    <div class="otp-body">
        ...
        <p style="text-align:center;font-size:0.88rem;color:#6b7280;margin-bottom:0">
            Enter the 6-digit OTP. Valid for <strong>3 minutes</strong>.
        </p>
        ...
        <form action="{{ route('admin.otp.verify') }}" method="POST" id="otpForm">
            ...
            <div class="text-center mb-4">
                <span class="countdown" id="countdown">Expires in <strong id="timer">3:00</strong></span>
            </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-3">
            <form action="{{ route('admin.otp.resend') }}" method="POST" id="resendForm">
                @csrf
            ...
            <a href="{{ route('login') }}" style="font-size:0.82rem;color:#6b7280;text-decoration:none">
...
(function () {
    ...
    const tick = setInterval(() => {
        ...
        if (seconds <= 0) {
            ...
            cntEl.innerHTML = '<strong>OTP expired.</strong> Please resend or login again.';
