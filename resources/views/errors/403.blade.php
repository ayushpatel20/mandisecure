...
<head>
    ...
    <title>Access Forbidden — MandiSecure</title>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(155deg, #1a0a0a 0%, #6b1a1a 50%, #421010 100%);
            min-height: 100vh;
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                ...
                <p style="color:rgba(255,255,255,0.65);max-width:420px;margin:0 auto 2rem;line-height:1.7">
                    ...
                    please contact support or log in with an authorised account.
                </p>
                ...
                <div style="margin-top:3rem;font-size:0.82rem;color:rgba(255,255,255,0.35)">
                    <a href="/" style="color:rgba(255,255,255,0.45);text-decoration:none">
                        <i class="bi bi-tree-fill me-1" style="color:#e8a020"></i>MandiSecure
                    </a>
                </div>
            </div>
        </div>
